...
@section('content')
	...
	<div class="container-fluid">
            <div class="block-header">
                <h2>
                    Tableau de bord / {{$info->nom}} {{$info->prenom}}
                    <input type="hidden" id="personnel" value="{{ $info->id }}" />
                    <small></small>
                </h2>
            </div>
        ...
        <script type="text/javascript">
            ...
            async function getlistAntecedent() {
                    try {
                        let response = await fetch("{{route('GPA')}}",
                        {
                            method: 'get',
                            headers: {
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#updateantecedent" onclick="getupdateantecedent('+currentline["id"]+', \''+currentline["type"]+'\', \''+currentline["chirurgicaux"]+'\', \''+currentline["medicaux"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#deleteantecedent" onclick="getdeleteantecedent('+currentline["id"]+', \''+currentline["type"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideantecedent(){
                ...
                if(token == "" || typeantecedent == "" || chirurgicaux == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SAPA')}}",
                            {
                                method: 'POST',
                                headers: { 
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteantecedent(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('DPA')}}",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistPosteAnt() {
                    try {
                        let response = await fetch("{{route('GPPA')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateposteant('+currentline["id"]+', \''+currentline["denomination"]+'\', \''+currentline["libelle"]+'\', \''+currentline["periodedebut"]+'\', \''+currentline["periodefin"]+'\', \''+currentline["facteurnuissance"]+'\', '+currentline["entreprise"]+')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteposteant('+currentline["id"]+', \''+currentline["denomination"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideposteant(){
                ...
                if(token == "" || entreprise == 0 || periodefin == "" || periodedebut == "" || factnuissance == "" || denomination == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SPAP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteposteant(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('DPSP')}}",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistPosteActu() {
                    try {
                        let response = await fetch("{{route('GPPAc')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateposteactu('+currentline["id"]+', \''+currentline["poste"]+'\', \''+currentline["taches"]+'\', \''+currentline["periodedebut"]+'\', \''+currentline["periodefin"]+'\', \''+currentline["facteurnuissance"]+'\', \''+currentline["metrodate"]+'\', \''+currentline["metrotype"]+'\', \''+currentline["metror"]+'\', \''+currentline["rythme"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteposteactu('+currentline["id"]+', \''+currentline["poste"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideposteactu(){
                ...
                if(token == "" || poste == "" || periodefin == "" || periodedebut == "" || facteurnuissance == "" || taches == "" || rythme == "" || metrodate == "" || metrotype == "" || metror == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SPAcP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteposteactu(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('DPAcP')}}",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistVaccination() {
                    try {
                        let response = await fetch("{{route('GVP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateVaccination('+currentline["id"]+', \''+currentline["date"]+'\', \''+currentline["vaccin"]+'\', \''+currentline["lot"]+'\', \''+currentline["type"]+'\', \''+currentline["dose"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteVaccination('+currentline["id"]+', \''+currentline["vaccin"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideVaccination(){
                ...
                if(token == "" || datevacc == "" || vaccinvacc == "" || lotvacc == "" || dosevacc == "" || typevacc == "" ){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SVP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteVaccination(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('DVP')}}",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistAbsenteisme() {
                    try {
                        let response = await fetch("{{route('GABP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateAbsenteisme('+currentline["id"]+', \''+currentline["type"]+'\', \''+currentline["cause"]+'\', \''+currentline["debut"]+'\', \''+currentline["reprise"]+'\', \''+currentline["njaa"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteAbsenteisme('+currentline["id"]+', \''+currentline["debut"]+" au "+currentline["reprise"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideAbsenteisme(){
                ...
                if(token == "" || nombrejoursarretabse == "" || typeabse == "" || causeabse == "" || debutabse == "" || repriseabse == "" ){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SABP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteAbsenteisme(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('DABP')}}",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistAccident() {
                    try {
                        let response = await fetch("{{route('GACCP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateAccident('+currentline["id"]+', \''+currentline["date"]+'\', \''+currentline["emc"]+'\', \''+currentline["ndl"]+'\', \''+currentline["poste"]+'\', \''+currentline["nja"]+'\', \''+currentline["ipp"]+'\', \''+currentline["obs"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteAccident('+currentline["id"]+', \''+currentline["ndl"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideAccident(){
                ...
                if(token == "" || obsacci == "" || ippacci == "" || njaacci == "" || posteacci == "" || ndlacci == "" || dateacci == "" || emcacci == "" ){
                    ...
                    document.getElementById("infoacci").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                        ...
                        try {
                            let response = await fetch("{{route('SACCP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteAccident(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    try {
                        let response = await fetch("{{route('DACCP')}}",
                        {
                            method: 'POST',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistMaladie() {
                    try {
                        let response = await fetch("{{route('GMalP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateMaladie('+currentline["id"]+', \''+currentline["date"]+'\', \''+currentline["maladie"]+'\', \''+currentline["tableau"]+'\', \''+currentline["agent"]+'\', \''+currentline["poste"]+'\', \''+currentline["decision"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteMaladie('+currentline["id"]+', \''+currentline["maladie"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideMaladie(){
                ...
                if(token == "" || datemala == "" || maladiemala == "" || tableaumala == "" || agentmala == "" || postemala == "" || decisionmala == ""){
                    ...
                    document.getElementById("infomala").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                        ...
                        try {
                            let response = await fetch("{{route('SMalP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteMaladie(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    try {
                        let response = await fetch("{{route('DMalP')}}",
                        {
                            method: 'POST',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
            ...
            async function getListConvocation() {
                    try {
                        let response = await fetch("{{route('GConvP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateConvocation('+currentline["id"]+', \''+currentline["motif"]+'\', \''+currentline["dateemission"]+'\', \''+currentline["dateconvocation"]+'\', \''+currentline["datepresentation"]+'\', \''+currentline["obs"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteConvocation('+currentline["id"]+', \''+currentline["motif"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideConvocation(){
                ...
                if(token == "" || motifconv == "" || dateemissionconv == "" || dateconvocationconv == "" || datepresentationconv == "" || obsconv == ""){
                    ...
                    document.getElementById("infoconv").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                        ...
                        try {
                            let response = await fetch("{{route('SConvP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteConvocation(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    try {
                        let response = await fetch("{{route('DConvP')}}",
                        {
                            method: 'POST',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
            ...
            async function getListConsultationn() {
                    try {
                        let response = await fetch("{{route('GConsP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateConsultation('+currentline["id"]+', \''+currentline["date"]+'\', \''+currentline["plainte"]+'\', \''+currentline["constante"]+'\', \''+currentline["examen"]+'\', \''+currentline["diagnostic"]+'\', \''+currentline["traite"]+'\', \''+currentline["bilan"]+'\', \''+currentline["obs"]+'\')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteConsultation('+currentline["id"]+', \''+currentline["plainte"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideConsultation(){
                ...
                if(token == "" || datecons == "" || plaintecons == "" || constantecons == "" || examencons == "" || diagnosticcons == "" || bilancons == "" || traitecons == "" || obscons == ""){
                    ...
                    document.getElementById("infocons").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                        ...
                        try {
                            let response = await fetch("{{route('SConsP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
            ...
            async function setdeleteConsultation(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    try {
                        let response = await fetch("{{route('DConsP')}}",
                        {
                            method: 'POST',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
            ...
            async function getlistVisite() {
                    try {
                        let response = await fetch("{{route('GVisiteP')}}",
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<td>';
                                contenu += '@if(in_array("update_caract_outil", session("auto_action"))) <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getupdateVisite('+currentline["id"]+', '+currentline+')"> <i class="material-icons">system_update_alt</i></button> @endif';
                                contenu += '@if(in_array("delete_outil", session("auto_action")))<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onclick="getdeleteVisite('+currentline["id"]+', \''+currentline["plainte"]+'\')"><i class="material-icons">delete_sweep</i></a> </button> @endif';
                                contenu += "</td>";
                                contenu += '</tr>';
                            }); 
                            if(contenu == "")
            ...
            async function valideVisite(){
                ...
                if(token == "" || plaintevisite == "" || examenvisite == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SVisiteP')}}",
                            {
                                method: 'POST',
                                headers: {
                                            'Access-Control-Allow-Credentials': true,
