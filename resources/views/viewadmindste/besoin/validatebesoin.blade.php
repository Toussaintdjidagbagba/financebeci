	...
	<div class="row clearfix">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="body">
					<div class="row">
                        <form method="post" action="{{route('validbesoin')}}">
                        {{-- <form method="post" action="#"> --}}
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-line">
                                        <select type="text" id="statut" name="statut" value="{{ $parcour->statut }}" class="form-control" placeholder="">
                                            <option @if($parcour->statut =='ENCOURS TRAITEMENT') selected @endif>ENCOURS TRAITEMENT</option>
                                            <option @if($parcour->statut =='ACCEPTER') selected @endif>ACCEPTER</option>
                                            <option @if($parcour->statut =='REFUSER') selected @endif>REFUSER</option>
                                            <option @if($parcour->statut =='REPOUSSER') selected @endif>REPOUSSER</option>
                                        </select>
                                    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select type="text" id="chefSuivant" name="chefSuivant" class="form-control" placeholder="" value="{{ $parcour->validateur }}">
                                            @php
                                                $userschef = App\Providers\InterfaceServiceProvider::UtilisateurChef();
                                            @endphp
                                            @foreach($userschef as $user)
                                                <option value="{{$user->idUser}}" @if($user->idUser==$parcour->validateur) selected @endif>{{$user->nom}} {{$user->prenom}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea  id="comment" name="comment" value="{{ $parcour->commentaire }}" class="form-control" placeholder="">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input readonly type="date" id="date" name="date" class="form-control" placeholder="" value="{{ $info->dateemission }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select disabled type="text" id="demandeur" name="demandeur" class="form-control" placeholder="" value="{{ $info->user }}">
                                                @php
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select disabled type="text" id="urgence" name="urgence" value="{{ $info->urgence }}" class="form-control" placeholder="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select disabled type="text" id="chef" name="chef" class="form-control" placeholder="" value="{{ $parcour->validateur }}">
                                            @php
                                                $userschef = App\Providers\InterfaceServiceProvider::UtilisateurChef();
                                            @endphp
                                            @foreach($userschef as $user)
                            ...
                            @if (session('utilisateur')->idUser == $parcour->validateur)
