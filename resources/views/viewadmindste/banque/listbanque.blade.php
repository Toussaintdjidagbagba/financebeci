                                ...
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align:middle; text-align: center;">{{ $serv->libelle }}</td>
...
<script type="text/javascript">
        ...
        async function validelb()
        {
                ...
                if(token == "" || lib == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('AB')}}",
                            {
                                method: 'POST',
                                headers: { 
        ...
        async function validedelete(){
                ...
                dat = {_token: token, lib: iddelete, id: id,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('DB')}}",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
