                                ...
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align:middle; text-align: center;">{{ $serv->titre }}</td>
                                            <td style="vertical-align:middle; text-align: center;">{{ $serv->refinterne }}</td>
                                            <td style="vertical-align:middle; text-align: center;">{{ $serv->refcontrat }}</td>
                                            ...
                                            <button onclick="getactor({{$serv}})" type="button" title="Définir les acteurs" data-toggle="modal" data-target="#acteur" class="btn btn-circle btn-xs margin-bottom-10 bouton-clignotant">
                                                     <i class="material-icons">group</i>
                                            </button>
                                            @else
                                            <button onclick="getactor({{$serv}})" type="button" title="Définir les acteurs" data-toggle="modal" data-target="#acteur" class="btn btn-circle btn-xs margin-bottom-10 ">
                                                     <i class="material-icons">group</i>
                                            </button>
                                            @endif
                                            ...
                                            <!--
                                            @if($serv->montantttc == "" || $serv->montantttc == null || $serv->montantttc == 0)
                                            <button onclick="getdevis({{$serv}})" type="button" title="Définir les acteurs" data-toggle="modal" data-target="#devis" class="btn btn-circle btn-xs margin-bottom-10 bouton-montant">
                                                     <i class="material-icons">view_list</i>
                                            </button>
                                            @else
                                            <button onclick="getdevis({{$serv}})" type="button" title="Définir les acteurs" data-toggle="modal" data-target="#devis" class="btn btn-circle btn-xs margin-bottom-10 ">
                                                     <i class="material-icons">view_list</i>
                                            </button>
                                            @endif -->
                                                ...
                                                <button onclick="getupdate({{$serv}}, '{{ App\Providers\InterfaceServiceProvider::ProjetListe($serv->idProj) }}')" type="button" title="Modifier" data-toggle="modal" data-target="#update" class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                     <i class="material-icons">system_update_alt</i> 
                                                </button>
                                                @endif

                                                @if(in_array("delete_service", session("auto_action")))
                                                <button onclick="getdelete({{$serv->idProj}})"type="button" title="Supprimer" data-toggle="modal" data-target="#delete" class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><i class="material-icons">delete_sweep</i> 
                                                </button>
                                                @endif
                                ...
                                <div class="form-line">
                                    <select type="text" id="maitre" name="maitre" class="form-control" placeholder="">
                                        ...
                                        @foreach($comptes as $compte)
                                            <option value="{{$compte->idUser}}">{{$compte->nom}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select type="text" id="chefprojet" name="chefprojet" class="form-control" placeholder="">
                                        ...
                                        @endphp 
                                        @foreach($lbg as $lb)
                                            <option value="{{$lb->idUser}}">{{$lb->nom}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select type="text" id="partenaire" name="partenaire" class="form-control" placeholder="">
                                        ...
                                        @foreach($part as $prt)
                                            <option value="{{$prt->id}}">{{$prt->nom}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        async function validelb(){
                ...
                if(token == "" || titre_projet == "" || refinterne == "" || refcontrat == ""|| datedebut == "" || datefin == "" || financement == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SAP')}}",
                            {
                                method: 'POST',
                                headers: { 
        ...
        async function getlistpartenaire(projet){
            try {
                        let response = await fetch("{{route('GPTNP')}}?ap_projet="+projet,
                        {
                            method: 'get',
                            headers: {
                                'Access-Control-Allow-Credentials': true,
        ...
        async function validepartenaire(){
            ...
            projet = document.getElementById("ipprojet").value;
                ...
                if(token === "" || (nompart === "" && partenaire === "")){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('GPTNP')}}",
                            {
                                method: 'POST',
                                headers: { 
                                            'Access-Control-Allow-Credentials': true,
        ...
        async function setdefinitionactor(){
            ...
            projet = document.getElementById("ipprojet").value;
                ...
                if(token === "" || (maitre === "" || chefprojet === "")){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("{{route('SAAP')}}",
                            {
                                method: 'POST',
                                headers: { 
                                            'Access-Control-Allow-Credentials': true,
        ...
        async function valideupdate() {
            ...
            if (token === "" || titre_projet === "" || numero_contrat === "" || maitre === "" || titulaire === "" || prestation === "" || tp_financement === "" || financement === "" || montant === "" || delaiExecution === "" || objet === "") {
                ...
                try {
                    // Envoi de la requête
                    const response = await fetch("{{route('SAP')}}", {
                        method: 'POST',
                        headers: {
                            'Access-Control-Allow-Credentials': true,
                            'Content-Type': 'application/json',
                    ...
                    if (response.status === 200) {
                        ...
                        if (reponse.status === 0) {
                            ...
                            setTimeout(function () {
                                window.location.href = "{{route('GLBGT')}}";
                            }, 3000);
                        } else {
