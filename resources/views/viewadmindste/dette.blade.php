                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th data-priority="1">Intitulé débit</th>
                                        <th data-priority="1">Montant</th>
                                        <th data-priority="1">Ligne budgetaire</th>
                                        <th data-priority="1">Date d'echeance</th>
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8"><center>Pas de dette enregistrer!!!</center> </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                            <label for="lib">Intitulé débit : </label>
                           <div class="form-group">
                            <div class="form-line">
                                <input type="number" id="lib" name="lib" class="form-control" placeholder="">
                            </div>
