	...
	<div class="row clearfix">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="body">
					<div class="row">
                        <form method="post" action="<?php echo e(route('modifierbesoin')); ?>">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" id="date" name="date" class="form-control" placeholder="" value="<?php echo e($info->dateemission); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select type="text" id="demandeur" name="demandeur" class="form-control" placeholder="" value="<?php echo e($info->user); ?>">
                                                <?php
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select type="text" id="urgence" name="urgence" value="<?php echo e($info->urgence); ?>" class="form-control" placeholder="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select type="text" id="chef" name="chef" class="form-control" placeholder="" value="<?php echo e($parcour->validateur); ?>">
                                            <?php
...
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documents\DSAF TECHNOLOGIE\DJIDAGBAGBA\Finance\financebeci\resources\views/viewadmindste/besoin/modifbesoin.blade.php ENDPATH**/ ?>