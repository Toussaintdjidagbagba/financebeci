                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" title="Détail"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                    <a href="<?php echo e(route('GDSDC')); ?>" style="color:white;"> <i class="material-icons">apps</i></a> 
                                                </button>
                                            </td>
                                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/sc.blade.php ENDPATH**/ ?>