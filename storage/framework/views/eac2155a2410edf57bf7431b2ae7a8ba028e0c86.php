                                ...
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align:middle; text-align: center;"><?php echo e($serv->nom); ?></td>
                                            <td style="vertical-align:middle; text-align: center;"><?php echo e($serv->adresse); ?></td>
    ...
    <script type="text/javascript">
                ...
                if((token == "" || nom == "" || adresse == "")) {
                    ...
                    dat = {
                        _token: token, p_nom: nom, p_adresse: adresse
                            ...
                            // En cours d'envoie
                            try {
                                let response = await fetch("<?php echo e(route('APTN')); ?>",
                                {
                                    method: 'POST',
                                    headers: { 
                                ...
                                if(response.status == 200)
                                {
                                    ...
                                    if(reponse.status == 0)
                                    {
                                        ...
                                        setTimeout(function(){
                                            window.location.href = "<?php echo e(route('GPTN')); ?>";
                                        }, 3000);
                                    }else{
        ...
        async function validedelete(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("<?php echo e(route('DPTN')); ?>",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/partenaire/list.blade.php ENDPATH**/ ?>