            ...
            <div class="row clearfix">
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Liste des planifications de projet
                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th data-priority="1">Titre du projet</th>
                                        <th data-priority="1">Taux de répartition</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="7"><center>Pas de planification enregistrer!!!</center> </td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/planification.blade.php ENDPATH**/ ?>