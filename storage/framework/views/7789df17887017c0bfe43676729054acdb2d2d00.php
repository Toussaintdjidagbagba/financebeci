	...
	<div class="row clearfix">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="body">
					<div class="row">
                        <form method="post" action="<?php echo e(route('validbesoin')); ?>">
                        
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                            <!-- Champ caché pour stocker les données du tableau -->
                            <input type="hidden" name="tableauDonnees" id="tableauDonneesJSON">
                            <input type="hidden" name="idbesoin" value="<?php echo e($info->id); ?>">
                            <input type="hidden" name="idparcour" value="<?php echo e($parcour->id); ?>">

                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <label for="struc">Statut : </label>
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select type="text" id="statut" name="statut" value="<?php echo e($parcour->statut); ?>" class="form-control" placeholder="">
                                            <option <?php if($parcour->statut =='ENCOURS TRAITEMENT'): ?> selected <?php endif; ?>>ENCOURS TRAITEMENT</option>
                                            <option <?php if($parcour->statut =='ACCEPTER'): ?> selected <?php endif; ?>>ACCEPTER</option>
                                            <option <?php if($parcour->statut =='REFUSER'): ?> selected <?php endif; ?>>REFUSER</option>
                                            <option <?php if($parcour->statut =='REPOUSSER'): ?> selected <?php endif; ?>>REPOUSSER</option>
                                        </select>
                                    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="chef">Chef Suivant : </label>
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select type="text" id="chefSuivant" name="chefSuivant" class="form-control" placeholder="" value="<?php echo e($parcour->validateur); ?>">
                                            <?php
                                            ...
                                            <?php $__currentLoopData = $userschef; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($user->idUser); ?>" <?php if($user->idUser==$parcour->validateur): ?> selected <?php endif; ?>><?php echo e($user->nom); ?> <?php echo e($user->prenom); ?></option>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <label for="struc">commentaire : </label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea  id="comment" name="comment" value="<?php echo e($parcour->commentaire); ?>" class="form-control" placeholder="">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input readonly type="date" id="date" name="date" class="form-control" placeholder="" value="<?php echo e($info->dateemission); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select disabled type="text" id="demandeur" name="demandeur" class="form-control" placeholder="" value="<?php echo e($info->user); ?>">
                                                <?php
                                                    $users = App\Providers\InterfaceServiceProvider::allutilisateurspersonnel();
                                                ?>
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($user->idUser); ?>" <?php if($user->idUser==$info->user): ?> selected <?php endif; ?>><?php echo e($user->nom); ?> <?php echo e($user->prenom); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select disabled type="text" id="urgence" name="urgence" value="<?php echo e($info->urgence); ?>" class="form-control" placeholder="">
                                            <option <?php if($info->urgence=='MODERE'): ?> selected <?php endif; ?>>MODERE</option>
                                            <option <?php if($info->urgence=='CRITIQUE'): ?> selected <?php endif; ?>>CRITIQUE</option>
                                            <option <?php if($info->urgence=='ELEVE'): ?> selected <?php endif; ?>>ELEVE</option>
                                            <option <?php if($info->urgence=='FAIBLE'): ?> selected <?php endif; ?>>FAIBLE</option>
                                        </select>
                                    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <div class="form-line">
                                        <select disabled type="text" id="chef" name="chef" class="form-control" placeholder="" value="<?php echo e($parcour->validateur); ?>">
                                            <?php
                                                $userschef = App\Providers\InterfaceServiceProvider::UtilisateurChef();
                                            ?>
                                            <?php $__currentLoopData = $userschef; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(session('utilisateur')->idUser == $parcour->validateur): ?>
                                <button type="submit" class="btn bg-deep-orange waves-effect">Validate</button>
                            <?php endif; ?>
...
<script type="text/javascript">
        let donneesJson = [];
        let donneesInitiales = JSON.parse(<?php echo json_encode($donneesvJson, 15, 512) ?>)
        donneesJson = JSON.parse(<?php echo json_encode($donneesvJson, 15, 512) ?>)
...
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documents\DSAF TECHNOLOGIE\DJIDAGBAGBA\Finance\financebeci\resources\views/viewadmindste/besoin/validatebesoin.blade.php ENDPATH**/ ?>