...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Exécution de dépense sur projet
                    <small></small>
                </h2>
            </div>
                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="8"><center>Pas de dépenses exécutées enregistrer!!!</center> </td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Exécuter une dépense : </h4>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/executiondepense.blade.php ENDPATH**/ ?>