                        ...
                        <div class="body"> 
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td style="vertical-align:middle; text-align: center;"><?php echo e($index + 1); ?></td>
                                                <td>
                                                    <?php echo e($part->projettaux); ?> %
                                                </td>
                                                <td>
                                                    <?php echo e($part->resultat); ?> %
                                                </td>
                                                <td style="vertical-align:middle; text-align: center;">
                                                    <?php if(in_array("update_service", session("auto_action"))): ?>
                                                        <button onclick="getupdate(<?php echo e($part); ?>)" type="button" title="Modifier" data-toggle="modal" data-target="#update" class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                            <i class="material-icons">system_update_alt</i> 
                                                        </button>
                                                    <?php endif; ?>
                                                    <?php if(in_array("delete_service", session("auto_action"))): ?>
                                                        <button onclick="getdelete(<?php echo e($part); ?>)"type="button" title="Supprimer" data-toggle="modal" data-target="#delete" class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
...
<?php $__env->startSection("model"); ?>
    ...
    <script type="text/javascript">
        ...
        async function validepart(){
                ...
                // En cours d'envoie
                    try {
                        let response = await fetch("<?php echo e(route('ADMV')); ?>",
                        {
                            method: 'POST',
                            headers: { 
                        ...
                        if(response.status == 200)
                        {
                            ...
                            if(reponse.status == 0)
                            {
                                ...
                                setTimeout(function(){
                                    window.location.href = "<?php echo e(route('GPBC')); ?>";
                                }, 3000);
                            }else{
        ...
        async function validedelete(){
            ...
            // En cours d'envoie
            try {
                let response = await fetch("<?php echo e(route('DDMV')); ?>",
                {
                    method: 'POST',
                    headers: {
                                    'Access-Control-Allow-Credentials': true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/part/partbeci.blade.php ENDPATH**/ ?>