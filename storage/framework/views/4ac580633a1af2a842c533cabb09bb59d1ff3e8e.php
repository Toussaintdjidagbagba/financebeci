                    ...
                    <div class="row clearfix">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-6">
                                    ...
                                    <div class="form-line">
                                        <select type="text" id="sexe" name="sexe" class="form-control show-tick" placeholder="">
                                            <option value="F">ACM</option>
                                            <option value="M">ADC</option> 
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/virement.blade.php ENDPATH**/ ?>