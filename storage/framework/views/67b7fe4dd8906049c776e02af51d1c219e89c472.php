...
<body class="signup-page" style="background-image : url('photo.png');  background-repeat: repeat; background-size: cover; -webkit-background-size: cover;
...
-o-background-size: cover;">
    ...
    <div class="signup-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST" action="<?php echo e(route('loginS')); ?>">
                    ...
                    <div class="m-t-25 m-b--5 align-center">
                        <a href="<?php echo e(route('login')); ?>" style="font-weight: bold;">Se connecter</a>
                    </div>
                </form>
            </div>
        </div>
...
</html><?php /**PATH D:\Documents\DSAF TECHNOLOGIE\DJIDAGBAGBA\Finance\financebeci\resources\views/auth/password.blade.php ENDPATH**/ ?>