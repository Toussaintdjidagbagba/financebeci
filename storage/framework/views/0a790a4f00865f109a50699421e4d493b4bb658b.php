                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo e($serv->compte); ?></td>
                                            <td><?php echo e($serv->typecompte); ?></td>
                                            <td><?php echo e(number_format($serv->soldecourant, 0, '.', ' ')); ?></td>
                                            <td><?php echo e(number_format($serv->soldedisponible, 0, '.', ' ')); ?></td>
                                            <td><?php echo e($serv->numcompte); ?></td>
                                            <td>
                                                <button type="button" title="Détail"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                    <a href="<?php echo e(route('GDSC', $serv->id)); ?>" style="color:white;"> <i class="material-icons">apps</i></a> 
                                                </button>
                                                ...
                                                <?php if( $serv->soldedisponible == 0 && in_array("delete_service", session("auto_action"))): ?>
    ...
    <script type="text/javascript">
        ...
        async function validelb(){
                ...
                if(token == "" || lib == "" || soldedisponible == "" || soldecourant == ""){
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("<?php echo e(route('SAC')); ?>",
                            {
                                method: 'POST',
                                headers: { 
                            ...
                            if(response.status == 200)
                            {
                                ...
                                if(reponse.status == 0)
                                {
                                    ...
                                    setTimeout(function(){
                                        window.location.href = "<?php echo e(route('GSDC')); ?>";
                                    }, 3000);
        ...
        async function validedelete(){
                ...
                dat = {_token: token, id: iddelete,};
                    ...
                    // En cours d'envoie
                        try {
                            let response = await fetch("<?php echo e(route('DSC')); ?>",
                            {
                                method: 'POST',
                                headers: {
                                                'Access-Control-Allow-Credentials': true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/compte/situationcompte.blade.php ENDPATH**/ ?>