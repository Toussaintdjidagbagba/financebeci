                        	...
                        	<div class="table-responsive" data-pattern="priority-columns">
								<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
									...
									<tbody>
                                        ...
                                        <tr>
                                            <th><span class="co-name"><?php echo e($role->id); ?></span></th>
...
<script type="text/javascript">
    async function addTpfinance() {
        ...
        if (token === "" || libelle === "") {
            ...
            // En cours d'envoi
            try {
                response = await fetch("<?php echo e(route('AF')); ?>", {
                method: 'POST',
                headers: {
                ...
                if (response.status === 200) {
                    if (responseData.hasOwnProperty('message')) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('GF')); ?>";
                        }, 3000);
                    } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templatedste._temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\financebeci\resources\views/viewadmindste/typesfinancement/listtypesfinancement.blade.php ENDPATH**/ ?>