...
<body class="login-page" style="background-image : url('portailits.png'); background-repeat: no-repeat; background-size: cover; -webkit-background-size: cover;
...
</html><?php /**PATH C:\laragon\www\medecindoc\resources\views/auth/login.blade.php ENDPATH**/ ?>